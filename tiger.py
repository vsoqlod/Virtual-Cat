...
class Tiger(cat.Cat):
  ...
  def feed(self, player):
    ...
    if self.hunger >= 9:
      ...
      return self.name + " is absolutely stuff and decided to throw the fish at your face."  
      ...
      self.update_hunger(7)
      player.take_damage(5)
      return self.name + " is absolutely starving and bites you on the hand as it is upset at waiting so long for food." + self.name + " finishes the fish you gave it and is finally satisfied."
  ...
  def play(self, player):
    ...
    if self.hunger > 9:
      ...
      return self.name + " is starving, don't want to play right now. " + self.name + " stalks you, chases you down, tackles you, and takes a large chunk out of your arm for 8 damage."
  ...
  def pet(self, player):
    ...
    if self.hunger >= 9: 
      ...
      self.update_hunger(-2)
      player.take_damage(3)
      return self.name + " is annoyed by your attempts to pet it and swipes your hand away for 3 damage."
    elif self.hunger <= 3:
      self.update_hunger(-2)
      player.take_damage(6)
      return self.name + " is starving and viscously attacks you with its claws for 6 damage as you try to pet it."