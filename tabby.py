...
class Tabby(cat.Cat):
  ...
  def feed(self, player):
    ...
    if self.hunger >= 9:
      ...
      self.update_hunger(6)
      player.take_damage(2)
      return self.name + " is absolutely starving and bites you on the hand for 2 damage as it is upset at having to wait so long for food." + self.name + " finishes the fish you gave it and is finally satisfied."
  ...
  def play(self, player):
    ...
    if self.hunger > 9:
      ...
      return self.name + " is starving, don't want to play right now. " + self.name + " stalks you, chases you down, tackles you, and takes a large chunk out of your arm for 3 damage."
  ...
  def pet(self, player):
    ...
    if self.hunger >= 9:
      ...
      self.update_hunger(-1)
      player.take_damage(1)
      return self.name + " is annoyed by your attempts to pet it and swipes your hand away for 1 damage."
    elif self.hunger <= 3:
      self.update_hunger(-1)
      player.take_damage(2)
      return self.name + " is starving and viscously attacks you with its claws for 2 damage as you try to pet it."
